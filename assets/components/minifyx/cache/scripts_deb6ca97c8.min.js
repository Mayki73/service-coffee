document.addEventListener("DOMContentLoaded", () => {
  ...
  $(".ancor-carusel-prew").click(function () {
    $(".carysel-vibor").slick("slickPrev");
  });
  $(".ancor-carusel-next").click(function () {
    $(".carysel-vibor").slick("slickNext");
  });
  $(".carysel-vibor").on(
    "beforeChange",
    function (event, slick, currentSlide, nextSlide) {
      ...
      if (nextSlide == 0) {
        $(".box-003 .carysel-vibor-row .n-vopros")
          .removeClass("n-vopros-1")
          .removeClass("n-vopros-2")
          .removeClass("n-vopros-3");
        $(".box-003 .carysel-vibor-row .n-vopros span").html(nextSlide + 1);
      }
      if (nextSlide == 1) {
        $(".box-003 .carysel-vibor-row .n-vopros")
          .addClass("n-vopros-1")
      ...
      if (nextSlide == 3) {
        $(".box-003 .carysel-vibor-row .n-vopros")
          ...
          .removeClass("n-vopros-2")
          .addClass("n-vopros-3");
        $(".box-003 .carysel-vibor-row .n-vopros").html("Успешно!");
      }
    }
  );
  $(".open-cloze-mmenu a").click(function (event) {
    event.preventDefault();
    if ($(".box-menu").hasClass("box-menu-fixed")) {
      $(".box-menu").removeClass("box-menu-fixed");
      $(".box-menu .item").addClass("d-none");
      $(".box-menu .open-cloze-mmenu .text").html("Меню");
      $(".box-menu .open-cloze-mmenu").removeClass("cloze");
    } else {
      $(".box-menu").addClass("box-menu-fixed");
      $(".box-menu .item").removeClass("d-none");
      $(".box-menu .open-cloze-mmenu .text").html("Свернуть");
      $(".box-menu .open-cloze-mmenu").addClass("cloze");
    }
  });
  $(".carusel-proizvoditel").slick({
    slidesToShow: 5,
    arrows: false,
    responsive: [
      {
  ...
  $(".box-002 .btn-click.prew").click(function () {
    $(".carusel-proizvoditel").slick("slickPrev");
  });
  $(".box-002 .btn-click.next").click(function () {
    $(".carusel-proizvoditel").slick("slickNext");
  });
  $(".carusel-otziv").slick({
    centerMode: true,
    slidesToShow: 3,
  ...
  $(".carusel-otziv-baton .nav-btn.prew").click(function () {
    $(".carusel-otziv").slick("slickPrev");
  });
  $(".carusel-otziv-baton .nav-btn.next").click(function () {
    $(".carusel-otziv").slick("slickNext");
  });
  ...
  $(".box-008 .row-table .item").on("click", function (event) {
    event.preventDefault();
    if ($(this).hasClass("visible")) {
      $(this).removeClass("visible");
      $(this).find(".icon_check_quiz").removeClass("d-none");
      $(this).find(".icon_check_quiz-act").addClass("d-none");
    } else {
      $(this).addClass("visible");
      $(this).find(".icon_check_quiz").addClass("d-none");
      $(this).find(".icon_check_quiz-act").removeClass("d-none");
    }
  });
  $(".popup-modal").magnificPopup({
    type: "inline",
    preloader: false,
    mainClass: "main_pop_forms",
    callbacks: {
      elementParse: function (item) {
        console.log("Start of popup initialization");
        var thisAttr = item.el;
        $("#modal-form p.citi").html(thisAttr.attr("title-popap"));
  ...
  $(".mainform").submit(async function (e) {
    ...
    if ($(this).find("input[type='tel']").inputmask("isComplete")) {
      ...
      if (til == "-1") {
		  try {
			const response = await fetch('https://service-coffee.by/.netlify/functions/sendMail', {
			  method: 'POST',
        ...
        //   data: th.serialize(),
        // }).done(function () {
        //   location.href = "form-ok.php";
        //   return;
        //   /*$("#modal-form").html('<p class="citi">Форма успешно отправлена!</p><div class="line_form"></div><p class="mb-30">Ожидайте оператор скоро свяжется с Вами.</p>');*/
  ...
  function maskScope(actionObj, maskset, opts) {
    function getMaskTemplate(baseOnInput, minimalPos, includeInput) {
      ...
      do {
        ...
        ((void 0 === maxLength || maxLength > pos) &&
    ...
    function isValid(pos, c, strict, fromSetValid) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      getMaskSet().validPositions[dp].match.def !==
                        bestMatch.match.def &&
                        (getMaskSet().validPositions[dp].generatedInput !==
                          !0 &&
                          validInputs.push(
      ...
      for (pndx++; maskPos > pndx; pndx++)
        void 0 === getMaskSet().validPositions[pndx] &&
          ...
          ((generatedPos = getLastValidPosition(pndx, !0) + 1),
          (result = _isValid(
            generatedPos,
            ...
            if (!strict)
              if (opts.numericInput === !0) {
                var buffer = maskset.buffer.slice("").reverse(),
                  bufferChar = buffer[opts.prefix.length];
                if (
                  "0" === bufferChar &&
...
(function ($) {
  ...
  var masksPaste = function (e) {
    ...
    if (text === undefined) text = window.clipboardData.getData("Text");
    setTimeout(function () {
      maskInit.call(input, text);
    }, 0);
    return true;
  };
